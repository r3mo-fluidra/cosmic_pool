...
CHEMISTRY_AGENT_CONFIG = AgentConfig(
    ...
    output_contract=_contract(
        ...
        "regulatory_limit carries ONLY a value a retrieved source attributes to "
        "a named code or jurisdiction. Expect to leave it null. This manual is "
        "educational and states so at every turn — 'typical educational "
        "targets', 'commonly cited', 'your local code controls and is often "
